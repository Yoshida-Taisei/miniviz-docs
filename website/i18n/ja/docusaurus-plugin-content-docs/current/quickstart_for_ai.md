---
description: AI ツールにそのまま渡せる Miniviz ガイドで、API 仕様、制約、サンプルコードをまとめています。
---
...
2. **データ可視化/グラフ化**: データベースでデータを確認
3. **グラフ作成**: 送信したデータをグラフで可視化/グラフ化
4. **通知設定**: 閾値を超えた場合にSlackやWebhookで通知
5. **画像送信**: Proプランで画像データを送信・可視化/グラフ化
